...
import test.java.framework.manager.cucumber.runtime.StepDefinitionMatch;
 ...
 * by adding {@link test.java.framework.manager.cucumber.runtime.formatter.UsageFormatter.UsageStatisticStrategy} to the usageFormatter
 */
class UsageFormatter implements Formatter, Reporter {
    ...
    private List<Long> getRawDurations(List<StepDuration> stepDurations) {
        return stepDurations.stream()
                .map(stepDuration -> stepDuration.duration.longValue()).collect(Collectors.toList());
    }
    ...
    /**
     * Add a {@link test.java.framework.manager.cucumber.runtime.formatter.UsageFormatter.UsageStatisticStrategy} to the formatter
     *
