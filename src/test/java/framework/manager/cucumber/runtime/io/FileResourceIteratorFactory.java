...
import static test.java.framework.manager.cucumber.runtime.io.ClasspathIterable.getPath;

/**
 * Factory which creates {@link FileResourceIterator}s.
 * <p/>
 * <p>{@link FileResourceIterator}s should be created for any cases where a
 * URL's protocol isn't otherwise handled. Thus, {@link #isFactoryFor(java.net.URL)}
