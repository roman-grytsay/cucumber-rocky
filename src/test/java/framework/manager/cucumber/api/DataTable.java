...
import test.java.framework.manager.cucumber.runtime.table.DiffableRow;
import test.java.framework.manager.cucumber.runtime.table.TableConverter;
import test.java.framework.manager.cucumber.runtime.table.TableDiffException;
import test.java.framework.manager.cucumber.runtime.table.TableDiffer;
...
public class DataTable {
    ...
    /**
     * Creates another table using the same {@link java.util.Locale} and {@link cucumber.api.Format} that was used to create this table.
     *
